<template>
    <f7-popup
        ...
        class="popup-bottom share-popup"
    >
            ...
            <div class="wifi-popup__form">
                <div class="wifi-popup__form_group">
                    ...
                    <div class="wifi-popup__form_field" :class="{copied: isCopied}">
                        <input id="share_url" type="text" readonly :value="isCopied ? 'Ссылка скопирована' : url">
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const copy = () => {
                let passwordToCopy = document.querySelector('#share_url');
