            ...
            <div class="wifi-popup__form">
                ...
                <div class="wifi-popup__form_group">
                    ...
                    <div class="wifi-popup__form_field" :class="{copied: isCopied}">
                        <input id="wifi_password" type="text" readonly :value="isCopied ? $t('password_copied') : partner?.wifi?.password">
                        <svg v-if="isCopied" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg v-else width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="copy">
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const copy = () => {
                let passwordToCopy = document.querySelector('#wifi_password');
