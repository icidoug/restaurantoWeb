    ...
    <f7-page id="home">
        <div class="home">
            ...
            <div class="home-menu">
                ...
                <f7-link class="home-menu__item" popup-open=".contacts-popup" style="display: none">
                    <div class="home-menu__item_icon">
                        <svg width="32" height="32" viewBox="0 0 337.559 337.559" xmlns="http://www.w3.org/2000/svg">
                            <path
