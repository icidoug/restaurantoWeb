<template>
    <f7-page id="home">
        <div class="home">
            ...
            <transition>
                <div class="home__footer padding-side" v-if="isVisibleFooter" :class="{'home__footer--order': orderItems.length > 0}">
                    ...
                    <f7-link v-if="orderItems.length > 0" href="/order/" class="btn btn--gray footer-btn">
                    ...
                    <f7-button class="btn btn--pink footer-btn" popup-open=".waiter-popup">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 16L22 16" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                            <path d="M4 19L20 19" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                            <path d="M20 16C20 10.4771 18.5 6 12 6C5.5 6 4 10.4772 4 16" stroke="white"
